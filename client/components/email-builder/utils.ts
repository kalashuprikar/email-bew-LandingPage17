...
// Section-related utilities (must be before createEmptyTemplate)
...
export function createEmptyTemplate(): EmailTemplate {
  // Create a default section for new templates
  const defaultSection = createEmptySection("Main Section");
